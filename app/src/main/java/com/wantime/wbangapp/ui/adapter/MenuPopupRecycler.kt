...
class MenuPopupRecycler(
    ...
    fun isShowHeadView(isShow: Boolean): MenuPopupRecycler {
    ...
    fun pushDataList(dataList: ArrayList<MenuPopupBean>) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val binding = DataBindingUtil.inflate(
            inflater,
            R.layout.new_ui_menu_pop_recyler_item,
            parent,
            false
        ) as NewUiMenuPopRecylerItemBinding
...
//        }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is IViewHolder) {
            holder.getBinding().menuBean = dataList[position-mHeaderCount]
    ...
    //内容
    class IViewHolder(private val binding: NewUiMenuPopRecylerItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun getBinding(): NewUiMenuPopRecylerItemBinding {
            return binding
        }
    }
